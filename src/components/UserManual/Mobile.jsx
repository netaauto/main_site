  ...
  return (
    <div className="mobile-manual">
      <div className="mobileBox">
        ...
        <div
          className="rightbox"
          style={{ display: active === "u" ? "block" : "none" }}
        >
        ...
        <div
          className="rightbox"
          style={{ display: active === "vrhd" ? "block" : "none" }}
        >
        ...
        <div
          className="rightbox"
          style={{ display: active === "vlhd" ? "block" : "none" }}
        >
        ...
        <div
          className="rightbox"
          style={{ display: active === "service" ? "block" : "none" }}
        >
          ...
          <a href={Download6} download target="_blank">
            <img
